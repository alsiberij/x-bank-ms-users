...
func (t *Transport) routes() http.Handler {
	...
	mux.HandleFunc("POST /v1/auth/telegram", defaultMiddlewareGroup.Apply(t.handlerTelegramBind))
	mux.HandleFunc("DELETE /v1/auth/telegram", defaultMiddlewareGroup.Apply(t.handlerTelegramDelete))
